...
|---|---|---|---|
| Gradient Boosting (XGBoost) | 73.84% | 74% | 74% |
| Neural Network (Keras) | 73.54% | 74% | 73% |
...
> Obese patients show significantly higher CVD rates compared to normal weight patients.
...
```
1. Open the notebook:
   👉 [Click here to open in Colab] ← (paste your Colab link here)
